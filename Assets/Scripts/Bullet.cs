...
public class Bullet : MonoBehaviour
{
	...
	private void OnCollisionEnter(Collision other)
	{
		...
		{
			Destroy(gameObject);
			((Explosion)Instantiate(PrefabManager.Instance.explosion, other.contacts[0].point, Quaternion.identity).GetComponentInChildren(typeof(Explosion))).player = player;
			return;
		}
