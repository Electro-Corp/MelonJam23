...
public class Grappling : MonoBehaviour
{
	...
	private void Update()
	{
		...
		{
			Vector2 vector = (connectedTransform.position - transform.position).normalized;
	...
	{
		RaycastHit[] array = Physics.RaycastAll(transform.position, dir, 10f, whatIsSickoMode);
